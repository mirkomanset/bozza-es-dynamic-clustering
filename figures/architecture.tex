\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=1.5cm and 2cm, every node/.style={font=\small}]
        ...
        \node (online) [rectangle, draw, rounded corners, text centered, minimum height=1cm, below=2cm of stream] {\shortstack{Online\\(Micro-clustering)}};

        \node (offline) [rectangle, draw, rounded corners, text centered, minimum height=1cm, below=of online] {\shortstack{Offline\\(Macro-clustering)}};
